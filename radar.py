# تحميل نسخة معدلة بالكامل (بدون الحاجة 
import asyncio
from solana.rpc.websocket_api import connect
from solders.pubkey import Pubkey

# ================== إعدادات ==================
HELIUS_API_KEY = "646ea1ed-2917-4644-a471-cef65623c174"   # ← غيرها بمفتاحك الكامل
...
async def main():
    ...
    async with connect(wss_url) as websocket:
        ...
        # تنسيق متوافق مع solders 0.27.1
        filter_mentions = {"mentions": [RAYDIUM_V4_PROGRAM]}
